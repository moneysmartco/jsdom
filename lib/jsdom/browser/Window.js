...
function Window(options) {
  ...
  define(this, {
    ...
    get location() {
      return (window._document) ? idlUtils.wrapperForImpl(idlUtils.implForWrapper(window._document)._location) : false;
    },
    get history() {
      return (window._document) ? idlUtils.wrapperForImpl(idlUtils.implForWrapper(window._document)._history) : false;
    },
    get navigator() {
      return navigator;
    },
